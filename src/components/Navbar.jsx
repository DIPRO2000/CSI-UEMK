...
const Navbar = () => {
    ...
    return (
        <div className={`flex items-center justify-between px-6 md:px-10 h-[15vh] sticky top-0 z-20 text-white 
            ${ScrollY > 50 ? "bg-blue-500" : "bg-transparent"} transition-all duration-300 ease-in-out`}>

            {/* Logo and Title */}
            <div className="flex items-center gap-4">
                <h2 className="text-3xl md:text-5xl">CSI UEMK</h2>
            ...
            <div className={`md:flex flex-col md:flex-row items-center gap-6 text-lg absolute md:static top-[12vh] left-0 w-full 
                ...
                <ul className="flex flex-col md:flex-row items-center gap-6 py-4 md:py-0">
                    <li className="cursor-pointer hover:text-black hover:scale-110"><NavLink to="/" onClick={() => setMenuOpen(false)}>HOME</NavLink></li>
                    <li className="cursor-pointer hover:text-black hover:scale-110"><NavLink to="/about" onClick={() => setMenuOpen(false)}>ABOUT</NavLink></li>
                    <li className="cursor-pointer hover:text-black hover:scale-110"><NavLink to="/team" onClick={() => setMenuOpen(false)}>TEAM</NavLink></li>
                    <li className="cursor-pointer hover:text-black hover:scale-110" onClick={() => setMenuOpen(false)}>GALLERY</li>
                    <li className="cursor-pointer hover:text-black hover:scale-110" onClick={() => setMenuOpen(false)}>CONTACT</li>
                </ul>
            </div>
        </div>
    );
