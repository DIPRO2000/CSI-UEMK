...
const TeamBox = (props) => {
    return (
        <>
            <div className="flex flex-col items-center justify-start relative w-full h-[400px] max-w-[350px] border-2 border-black rounded-2xl bg-blue-950 overflow-hidden hover:scale-105 transition-all duration-200 ease-in">
